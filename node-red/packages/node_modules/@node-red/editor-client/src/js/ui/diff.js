RED.diff = (function() {
    ...
    function parseNodes(nodeList) {
        ...
        var globals = [];
        var all = {};
    console.log("Kiểm tra 456", nodeList)
